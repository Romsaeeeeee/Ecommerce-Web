    ...
    return (
        <div className="w-full h-full relative">
            ...
            <div className={`${timer == 3 ? "w-fit h-full" : "hidden"} transition-all z-10 relative`}>
                <span className={`flex-1 h-full  ${timer == 3 ? 'animate-fadeIn' : timer == 1 ? 'animate-fadeOut' : ""}`} >
                    <img src={chair3} alt="model" className="w-full h-full " />
                </span>
            </div>
            <span className="w-fit h-fit absolute -top-4 left-10">
                <img src={blob} alt="blob" className="w-fit h-[600px] opacity-50 -z-0" />
            </span>
            <span className="w-fit h-fit absolute top-0 ">
                <img src={blob} alt="blob" className="w-fit h-[650px] opacity-50 -z-0" />
            </span>
        </div>
    );
}
